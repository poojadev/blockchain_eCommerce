...
class BuyerWalletDetails extends StatefulWidget {
  static const String routeName= "/BuyerWalletDetails";

  const BuyerWalletDetails({Key? key}) : super(key: key);

  @override
  _BuyerWalletDetailsState createState() => _BuyerWalletDetailsState();
}
...
class _BuyerWalletDetailsState extends State<BuyerWalletDetails> {
            ...
            return !snapshot.hasData
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String? price=snapshot?.data!.docs[0].get(
